...
function buscar_localizacao_atual() {
    ...
    if (navigator.geolocation) {
        navigator.geolocation.getCurrentPosition(mostrar_dados);
    } else {
        detalhes.innerHTML = "A Geolocalizacao nao e suportada neste browser.";
    }
    ...
    function mostrar_dados(position) {
        ...
        fetch('https://api.openweathermap.org/data/2.5/weather?lat=' + latitude + '&lon=' + longitude + '&appid=9007a57b713ded2cab57517001962537&units=metric')
            ...
            .then(data => {
                ...
                chuva_detalhado.innerHTML = chuvaValor + "%";
...
function abrir_forecast() {
    var coll = document.getElementsByClassName("abrir");
    var i;
...
function favorito1() {
    var cidade_fav1 = document.getElementById("local1").innerText;
    localStorage.setItem("favorite1", cidade_fav1);
...
function favorito2()
{
    var cidade_fav2 = document.getElementById("local2").innerText;
    localStorage.setItem("favorite2", cidade_fav2);
    contador = (parseInt(localStorage.getItem("contador")) || 0);
    contador = contador + 1;
    localStorage.setItem("contador", contador);
    alert("Adicionado aos favoritos com sucesso!!");
...
function favorito3()
{
    var cidade_fav3 = document.getElementById("local3").innerText;
    localStorage.setItem("favorite3", cidade_fav3);
    contador = (parseInt(localStorage.getItem("contador")) || 0);
    contador = contador + 1;
    localStorage.setItem("contador", contador);
    alert("Adicionado aos favoritos com sucesso!!");
...
function favorito4()
{
    var cidade_fav4 = document.getElementById("local4").innerText;
    localStorage.setItem("favorite4", cidade_fav4);
    contador = (parseInt(localStorage.getItem("contador")) || 0);
    contador = contador + 1;
    localStorage.setItem("contador", contador);
    alert("Adicionado aos favoritos com sucesso!!");
...
function favorito5()
{
    var cidade_fav5 = document.getElementById("local5").innerText;
    localStorage.setItem("favorite5", cidade_fav5);
    contador = (parseInt(localStorage.getItem("contador")) || 0);
    contador = contador + 1;
    localStorage.setItem("contador", contador);
    alert("Adicionado aos favoritos com sucesso!!");
...
function favorito6()
{
    var cidade_fav6 = document.getElementById("local6").innerText;
    localStorage.setItem("favorite6", cidade_fav6);
    contador = (parseInt(localStorage.getItem("contador")) || 0);
    contador = contador + 1;
    localStorage.setItem("contador", contador);
    alert("Adicionado aos favoritos com sucesso!!");
...
{
    var cidade_fav_detalhe = document.getElementById("cidade_texto").innerText;
    localStorage.setItem("favoritedetalhe", cidade_fav_detalhe);
    contador_detalhe = (parseInt(localStorage.getItem("contador_detalhe")) || 0);
    contador_detalhe = contador_detalhe + 1;
    localStorage.setItem("contador_detalhe", contador_detalhe);
    alert("Adicionado aos favoritos com sucesso!!");
}